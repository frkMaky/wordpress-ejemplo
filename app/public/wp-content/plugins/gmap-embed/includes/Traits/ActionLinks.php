...
trait ActionLinks {
	...
	public function gmap_srm_settings_link( $actions ) {
		$links = array();
		if ( ! _wgm_is_premium() ) {
			$links['upgrade-to-pro'] = '<a target="_blank" style="color: #11967A;font-weight:bold;" href="' . esc_url( 'https://wpgooglemap.com/pricing?utm_source=admin_plugins&utm_medium=admin_link&utm_campaign=plugin_action_link' ) . '">' . __( 'Upgrade To Pro ($29 only)' ) . '</a>';
		}

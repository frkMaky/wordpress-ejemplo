(function ($) {
    $(document).ready(
        function () {
             ...
             * @since 1.9.0
             */
            $(document.body).find(".wgm_api_create_gplatform").on(
                'click',
                function (e) {
                    e.preventDefault();
                    const wgmDimensions = {
                    ...
                    window.open('https://console.cloud.google.com/google/maps-hosted', 'WP Google Map - Create your API key',
                        'resizable=yes,width='+wgmDimensions.width+',height='+wgmDimensions.height+',left='+wgmPopupLeft+',top='+wgmPopupTop);
                    return false;
                }
            );
        }

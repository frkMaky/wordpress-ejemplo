								...
								Swal.fire(
									{
										...
										html: wgm_l.locales.sweet_alert.notice_unlimited_marker + '<br><br><span style="font-size:25px;font-weight:bold;">Only $29 for Lifetime</span><br><br><a target="_blank" href="' + wgm_l.get_p_v_url + '">Upgrade to Pro Version (Only $29 for Lifetime)</a>'
									}
								);
								parent.find( '.spinner' ).css( 'visibility', 'hidden' );
								return false;
